class HyperionStudent(object):
	'''
		...
		learn basic and advanced programming with our courses.
	'''
	...
	def register():
		if self.education == 'beginner':
			...
			print "Coming top in your Computer Science courses?" +" We'll challenge you with courses in Artificial Intelligence."
