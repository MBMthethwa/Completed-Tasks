...
# Imagine the type of data you could store in a list - names, phone numbers, file names, email messages etc.
# For each of these, think of the variable types that would be used for each list (i.e. a list of Strings or a list of integers or doubles?)
...
# The above loop will loop over all items of the alphabet list, and only print out the item if it is equal to 'a'.
