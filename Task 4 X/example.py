...
# Congratulations! You've made it to the next task.
...
# Just like with basic tools our ancestors used (such as stone hammers/bone daggers), we have moved on to make advanced tools such as Jet Engines, Skyscrapers
...
# Sounds crazy right? It isn't. When people study 'Computer Science', this is the core theme of the science. Why not read up a bit about it and Turing, or watch the recent movie - 'The Imitation Game' which is about Turing's life.
# You may also be interested in knowing that human DNA has been proven to be Turing-Complete. 
...
stringList = ['John', 'Mary', 'Harry'] # Python knows that anything defined in [] is an array (in Java) which in Python is known as a list. There are 3 String
# items in this list.
...
print stringList[0] # Prints the 0th element of list, John. The 0th element of a list is also known as the first element of a list, or the 'element at index 0'.

print stringList[1:2] # Prints everything from the 1st to the 2nd element of list, NOT including the 2nd element. So it only prints the item in the 1st position; which is Mary.

print stringList[0:] # Prints everything from the 0th position to the end of the list i.e. the entire list.

print stringList # A faster way to print the entire list. 

stringList[2] = "Tom" # We can replace the 3rd element of the list with a new String. 'Harry' will be lost and replaced with 'Tom'. 
...
#	Now define a list called friends_ages, that stores the age of each of your friends in a corresponding manner - i.e. the first entry of this list is the age of the friend named first in your other list.
#
# ==================================================================================================
...
# Any type of list can be looped over using this construct. The above will print out the numbers 1 to 4 - i.e. the entries in list 'numbers'.
...
# The resulting list can be looped over like any list of intergers, i.e. to print the numbers from 1 to 10:
