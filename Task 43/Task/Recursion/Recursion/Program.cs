...
namespace Recursion
{
    class Program
    {
        ...
        private static int recursive_factorial(int n)
        {
            ...
            {
                return iterative_factorial(n - 1) + iterative_factorial(n - 2);
            }
        ...
        */
        ...
        {
            return word.Length; // Write the recursive implementation for calculating the string length
        }
        ...
        */
        private static int GCD(int x, int y)
        {
            ...
            return gcd; // Write the recursive implementation for calculating the greatest common divisor
        }
    }
}
