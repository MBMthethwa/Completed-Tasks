...
# If you declare variables, you may want the person running your program to be able to see what's going on. This is known as program OUTPUT.
# The most common way to view program OUTPUT is to use print. 
# The print statement is very useful for debugging to see what values variables hold and what parts of the code are running.
...
# The following command raw_input will show the text "Enter your name" in the output box of the program and the program will halt
# until the user enters something with their keyboard and presses ENTER.
# Similarly with the following raw_input command to get the user's age. 
...
#   This is because spacing and indentation is important in Python.
#   Be careful when using tab and space as these are different spacing characters.
#   To fix this in Notepad++ go to the Settings tab -> Preferences.. -> Tab Settings - > Tick the "Replace by space" box.
# 
...
# 	The program will then output(print) your name which was automatically stored in the variable name which you specified it should print out.
# 	Congratulations on creating your first persistent Python code! Using the tools you will learn after this, you can write complex, logical and useful programs. :)
# 
...
# 	Run the file in IDLE. Note the errors, fix them and get the program to run and finally output(print) the message.
